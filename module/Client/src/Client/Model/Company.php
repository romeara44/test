...
class Company
{
    ...
    const HIPAA_BASIC = 3;
    const HIPAA_EXPRESS = 2;
    const HIPAA_SELECT = 4;
    const HIPAA_EXPERT = 5;
    ...
    public $suppress_secondary_auth;
    public $is_training_sub_type;
    public $is_oig_express_sub_type;
    public $is_osha_express_sub_type;
    ...
    public function exchangeArray($data)
    {
        ...
        $this->hipaa_suite_type_id          = (isset($data['hipaa_suite_type_id'])) ? $data['hipaa_suite_type_id'] : 4;
        $this->suppress_secondary_auth      = (isset($data['suppress_secondary_auth'])) ? $data['suppress_secondary_auth'] : null;
        $this->is_training_sub_type         = (isset($data['is_training_sub_type'])) ? $data['is_training_sub_type'] : null;
        $this->is_oig_express_sub_type      = (isset($data['is_oig_express_sub_type'])) ? $data['is_oig_express_sub_type'] : null;
        $this->is_osha_express_sub_type     = (isset($data['is_osha_express_sub_type'])) ? $data['is_osha_express_sub_type'] : null;
