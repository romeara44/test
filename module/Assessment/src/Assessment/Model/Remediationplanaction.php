...
class Remediationplanaction
{
    ...
    public static $statusesNames = array('' => 'To-Do', self::STATUS_TODO => 'To-Do', self::STATUS_PENDING_APPROVAL => 'Pending Policy Approval', self::STATUS_PENDING_IMPLEMENTATION => 'Pending Implementation', self::STATUS_COMPLETED => 'Completed', self::STATUS_AUDITED => 'Audited');
    ...
    public $_rpa_latest_action_date_formatted;
    ...
    public function exchangeArray($data)
    {
        ...
        $this->_rpa_latest_action_date_formatted     = (isset($data['_rpa_latest_action_date_formatted'])) ? $data['_rpa_latest_action_date_formatted'] : null;
