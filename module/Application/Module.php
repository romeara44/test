    ...
    public function getServiceConfig()
    {
        return array(
            'factories' => array(
				...
				'Application\Model\ExceptionLogTable' =>  function($sm) {
                    $tableGateway = $sm->get('ExceptionLogTableGateway');
                    $table = new \Application\Model\ExceptionLogTable($tableGateway);
                    return $table;
                },
                'ExceptionLogTableGateway' => function ($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $resultSetPrototype = new ResultSet();
                    return new TableGateway('exception_log', $dbAdapter, null, $resultSetPrototype);
                },
