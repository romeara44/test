      ...
      if ($request->isPost()) {
        ...
        if(isset($post['issue'])){
				...
				if($user) {
						...
						$message = 'reporting issue generated by user = ' . $cName . ' phone(' . $cPhone. ') email(' . $cEmail. ')';	
				}else{
						$message = 'reporting issue';	
				}
				$message .= "<br><br>" . $cName . " entered = " . $issue;
				$sl->get('Mail\Model\MailtemplateTable')->sendMail($sl, array('type' => 'issue', 'message' => $message));
